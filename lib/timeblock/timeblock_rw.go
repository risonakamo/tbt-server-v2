...
func SaveTimeblock(timeblocksDict TimeblocksDict,filepath string) error {
    var jsonOut []byte
    var e error
...
func LoadTimeblock(filepath string) (error,TimeblocksDict) {
    var rfile []byte
    var e error
